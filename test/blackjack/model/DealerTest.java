...
public class DealerTest {
	...
	public void valorMaoComCartaAsTestSucesso() {
		...
		d.receberCarta(teste1);
		//Adicionando cartas na m�o do jogador  �s e Reis o dealer vai escolher o �s = 11
	...
	public void veBlackJackTestBoolMaisCartasFalse() {
		...
		//Adicionando mais de duas cartas na m�o do jogador iqual a 21
		//N�o deu BLACKJACK
		assertFalse(d.blackJackDealer());
	}
	...
	public void checkEstrategiaTest1() {
		...
		Carta teste1 = new Carta("H9");
		d.receberCarta(teste1);
		//n�o pode pegar mais cartas, possui mais que 17 pontos.
